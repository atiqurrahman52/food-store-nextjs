        ...
        <div className="py-20">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-5 md:space-y-8">
              <div>
                <h3 className="font-Montserrat font-semibold text-sm md:text-xl text-text_color mb-2">
                  Contact Details
                </h3>
                <p className="font-Montserrat text-xs md:text-base text-p_text">
                  Lorem ipsum dolor sit amet consectetur adipisc elit tortor eu
                  egestas morbi sem vulputate.
                </p>
              </div>

              <div className="flex flex-col md:flex-row gap-6">
                <a
                  className="flex flex-col items-center rounded-2xl border border-[#EBEBEE]w-full h-[86px] pt-4 px-5"
                ...
                >
                  ...
                  <span className="font-Montserrat text-base text-p_text">
                    example@example.com
                  </span>
                </a>
                <a
                  className="flex flex-col items-center rounded-2xl border border-[#EBEBEE] w-full h-[86px] pt-4"
              ...
              <h3 className="font-Montserrat font-semibold text-sm md:text-xl text-text_color">
            ...
            <div className="border border-[#EBEBEE] rounded-[22px] px-4 py-6 md:p-6">
              <form className="space-y-6">
                <div>
                  <label className="font-Montserrat text-base text-p_text mb-4 block">
                    Name
                  </label>
                  <input
                    type="text"
                    className="bg-[#F5F5F5] rounded-xl h-12 w-full focus:outline-none px-4 text-text_color"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea className="bg-[#F5F5F5] rounded-xl h-[132px] w-full focus:outline-none px-4 py-2 text-text_color"></textarea>
                </div>

                <button className="font-Montserrat font-medium text-sm md:text-base text-white bg-primary_3 text-center w-full h-10 md:h-[56px] rounded-xl">
                  Send Message
                </button>
              </form>
            </div>
