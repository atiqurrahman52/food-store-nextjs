            ...
            <div>
              ...
              <div className="pt-5">
                ...
                <button className="border px-[8px] md:px-[13px] py-[7px] md:py-[10px] rounded-md">
                  <img className="w-[30px] md:w-[45px] h-[18px] md:h-8" src='/assets/images/checkout/Mastercard.svg'
                    alt="" />
                </button>
                <button className="border px-[6px] md:px-[10px] py-[8px] md:py-[13px] rounded-md">
                  <img className="w-[34px] md:w-[51px] h-[14px] md:h-5" src='/assets/images/checkout/Stripe.svg' alt="" />
                </button>
                <button className="border px-[6px] md:px-[10px] py-[11px] md:py-[17px] rounded-md">
                  <img className="w-[26px] md:w-[40px] h-[23px] md:h-8" src='/assets/images/checkout/PayPal.svg' alt="" />
                </button>
                <button className="border px-[6px] md:px-[10px] py-[11px] md:py-[17px] rounded-md">
