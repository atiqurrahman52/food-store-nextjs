                    ...
                    <li>
                      <Link href="#">
                        ...
                        >
                          ...
                          />
                          <path
                            d="M0.362887 6.61157H4.89897V20H0.362887V6.61157Z"
                            fill="#606060"
                          />
                          <path
                ...
                <div className="flex gap-3 md:gap-6">
                  <button className="border px-[6px] md:px-[10px] py-[11px] md:py-[17px] rounded-md">
                    <Image
                      ...
                      src="/assets/images/checkout/visa-logo.svg"
                      alt=""
                      width={49}
                      height={16}
                    />
                  ...
                  <button className="border px-[8px] md:px-[13px] py-[7px] md:py-[10px] rounded-md">
                    <Image
                      className="w-[30px] md:w-[45px] h-[18px] md:h-8"
                      src="/assets/images/checkout/Mastercard.svg"
                      alt=""
                      width={49}
                      height={16}
                    />
                  ...
                  <button className="border px-[6px] md:px-[10px] py-[8px] md:py-[13px] rounded-md">
                    <Image
                      className="w-[34px] md:w-[51px] h-[14px] md:h-5"
                      src="/assets/images/checkout/Stripe.svg"
                      alt=""
                      width={49}
                      height={16}
                    />
                  ...
                  <button className="border px-[6px] md:px-[10px] py-[11px] md:py-[17px] rounded-md">
                    <Image
                      className="w-[26px] md:w-[40px] h-[23px] md:h-8"
                      src="/assets/images/checkout/PayPal.svg"
                      alt=""
                      width={49}
                      height={16}
                    />
                  ...
                  <button className="border px-[6px] md:px-[10px] py-[11px] md:py-[17px] rounded-md">
                    <Image
                      className="w-[32px] md:w-[50px] h-[13px] md:h-5"
                      src="/assets/images/checkout/GooglePay.svg"
                      alt=""
                      width={49}
                      height={16}
                    />
